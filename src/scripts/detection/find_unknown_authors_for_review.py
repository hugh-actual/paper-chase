...
OUTPUT_JSON = config.JSON_OUTPUT_DIR / "unknown_authors.json"
...
def main():
    ...
    print("\nNext steps:")
    print("1. Review the entries above")
    print(f"2. Open {OUTPUT_JSON} and fill in 'suggested_author' for each entry")
    print("3. Optionally update 'suggested_title' if title also needs fixing")
    print("4. Run update script to apply changes")
    print("=" * 120)
